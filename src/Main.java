        ...
        while (true) {
            ...
            switch (sceltaAdmin) {
                ...
                case 12: {
                    ...
                    for (Dispositivo dispositivoCarrello : carrello.getCarrello()) {
                        System.out.println("Prodotto: " + dispositivoCarrello.getModello() + ", Prezzo: " + dispositivoCarrello.getPrezzoVendita() + "€");
                    }
